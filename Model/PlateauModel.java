...
public class PlateauModel
{
    ...
    public boolean ajouteDomino(DominoModel e, int x, int y, String sens)              //Méthode pour ajouter un élément au plateau
    {
        if (plateau[x][y] == null)
        {
            ...
            for(int j = 0; j <9; j++)
            {
                if(getElement(i,j) != null)
                {
                    if (getElement(i,j) instanceof PaysageModel)
                    {
                        ...
                        {
                            System.out.print("D" + d.getIdElement() + (((PaysageModel) getElement(i,j)).getNomTerrain()) +
                    ...
                    {
                        System.out.print((((ElementModel) getElement(i, j)).getNom()) + (((ElementModel) getElement(i, j)).getIdElement()) + " | ");
                    }
                }
                else
                {
